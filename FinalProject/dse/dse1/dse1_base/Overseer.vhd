...
begin
    ...
    Flush: process(instruction_decode, take_branch, instruction_execute, in_buf_empty, predict_branch)
    begin
        ...
        elsif (instruction_decode(31 downto 26) = J) or (instruction_decode(31 downto 26) = JAL) or predict_branch = '1' then
            flush_decode <= '0';
            flush_execute <= '0';
            take_jump <= '1';
