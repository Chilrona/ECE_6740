...
use work.opcode_package.all;
	...
	process(instruction_in, tag_for_flush, predict_branch)
	begin
		if tag_for_flush = '1'then
			instruction_in_1 <= (others=> '0');
		elsif instruction_in(31 downto 26) = BNEZ or instruction_in(31 downto 26) = BEQZ then
			instruction_in_1 <= instruction_in(31 downto 26) & predict_branch & instruction_in(24 downto 0);
		else
			instruction_in_1 <= instruction_in;
		end if;
	end process;
	...
	(
        ...
        read_address_1 => instruction_in_1(20 downto 16),
        read_address_2 => instruction_in_1(15 downto 11),
        we => we,
        q_1 => q_1,
        q_2 => q_2
	);
    ...
    (
        ...
        imm => instruction_in_1(15 downto 0),
