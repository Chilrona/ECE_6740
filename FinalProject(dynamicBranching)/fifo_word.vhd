...
ARCHITECTURE SYN OF fifo_word IS
...
BEGIN
	...
	empty    <= sub_wire1;
	full    <= sub_wire2;
	q    <= sub_wire3(37 DOWNTO 0);
	usedw    <= sub_wire4(7 DOWNTO 0);

	scfifo_component : scfifo
	GENERIC MAP (
		add_ram_output_register => "OFF",
		almost_full_value => 254,
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL fifo_word.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL fifo_word.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL fifo_word.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL fifo_word.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL fifo_word_inst.vhd FALSE
